...
_BUILTIN_DEFINITIONS: list[dict] = [
    ...
    {
        "provider_type": "mailbox",
        "provider_key": "cloudmail_api",
        "label": "CloudMail（SkyMail）",
        "description": "CloudMail 兼容接口自建邮箱；填写管理员邮箱和密码后自动获取 Token，用于注册收发邮件和验证码",
        "driver_type": "cloudmail_api",
        "default_auth_mode": "password",
        "enabled": True,
        "category": "selfhost",
        "auth_modes": [
            {"value": "password", "label": "账号密码"},
            {"value": "token", "label": "Authorization Token"},
        ],
        "fields": [
            {
                "key": "skymail_api_base",
                "label": "API Base",
                "placeholder": "https://api.skymail.ink",
                "category": "connection",
                "default_value": "https://api.skymail.ink",
            },
            {
                "key": "skymail_domain",
                "label": "邮箱域名",
            ...
            },
            {
                ...
                "secret": True,
                "category": "auth",
                "hint": "留空则根据管理员邮箱密码自动获取；保存后可在设置页手动刷新",
            },
        ],
    },
    {
    ...
    },
    {
        ...
        "label": "5sim",
        "description": "5sim.net 接码平台 (https://5sim.net/docs)",
        "driver_type": "fivesim_api",
        "default_auth_mode": "apikey",
        "enabled": True,
        "category": "thirdparty",
        "auth_modes": [{"value": "apikey", "label": "API Token"}],
        "fields": [
            {"key": "fivesim_api_key", "label": "API Token", "secret": True, "category": "auth"},
            {
                "key": "fivesim_default_country",
                "label": "默认国家",
                "type": "async-select",
                "asyncUrl": "/sms/fivesim/countries",
                "asyncValueKey": "id",
                "asyncLabelKey": "chn",
                "placeholder": "请选择国家 (如 england / philippines / any)",
            },
            {
                "key": "fivesim_default_product",
                "label": "默认服务",
                "type": "async-select",
                "asyncUrl": "/sms/fivesim/services",
                "asyncValueKey": "code",
                "asyncLabelKey": "name",
                "asyncDependsOn": "fivesim_default_country",
                "asyncQueryParam": "country",
                "asyncListKey": "services",
                "placeholder": "请先选择国家，再选服务 (ChatGPT 选 OpenAI/ChatGPT)",
            },
            {"key": "fivesim_default_operator", "label": "默认运营商", "placeholder": "any"},
            {"key": "fivesim_max_price", "label": "最大价格 (可选)", "placeholder": "-1", "hint": "仅 operator=any 时作为 maxPrice 查询参数生效"},
            {"key": "fivesim_reuse", "label": "复用号码 (reuse=1)", "type": "toggle"},
            {"key": "fivesim_auto_country", "label": "自动选择最优国家", "type": "toggle", "hint": "启用后按产品价格和库存自动选国"},
